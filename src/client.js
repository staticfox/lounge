...
Client.prototype.connect = function(args) {
	...
	var network = new Network({
		...
		tls: !!args.tls,
		authserv_username: args.authserv_username,
		authserv_password: args.authserv_password,
	...
	network.irc.connect({
		...
		authserv_username: network.authserv_username,
		authserv_password: network.authserv_password,
		tls: network.tls,
